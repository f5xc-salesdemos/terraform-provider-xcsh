---
page_title: "f5xc_third_party_application Data Source - terraform-provider-f5xc"
subcategory: "Uncategorized"
description: |-
  Manages a Third Party Application resource in F5 Distributed Cloud for third party application specification. configuration. (read-only data source)
---

# f5xc_third_party_application (Data Source)
